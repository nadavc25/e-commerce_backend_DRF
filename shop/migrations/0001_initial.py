    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('size', models.CharField(choices=[('S', 'Small'), ('M', 'Medium'), ('L', 'Large'), ('XL', 'Extra Large'), ('2XL', 'Extra Large'), ('3XL', 'Extra Large'), ('4XL', 'Extra Large')], max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('review_image', models.ImageField(blank=True, help_text='Upload an image with your review', null=True, upload_to='review_images/')),
